...
const JobApplicationForm = () => {
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute bottom-10 w-full flex justify-between px-4">
          <button
            ...
            className="py-2 px-4 bg-gray-300 hover:bg-gray-400 text-white rounded"
          >
            Previous
          </button>
          <button
  ...
  const PersonalInfo = () => (
    <div>
      ...
      <input className="block w-full p-2 border rounded" placeholder="Name" />
      {/* Additional form fields */}
    </div>
  );
  
  const WorkExperience = () => <h2 className="text-2xl font-bold">Work Experience</h2>;
  const Education = () => <h2 className="text-2xl font-bold">Education</h2>;
  const Summary = () => <h2 className="text-2xl font-bold">Summary</h2>;
