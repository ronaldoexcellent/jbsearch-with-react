...
export default function GeneralProfile({guest}) {
    ...
    return (
        <div className="px-3 bg-gray-800 border-4 border-gray-600 rounded-2xl md:w-[630px] mx-auto text-white shadow-xl">
            <div className="relative bg-white mx-auto w-60 border-4 rounded-full items-center justify-center grid cursor-pointer">
                <img
                    alt="avatar"
                    src={avatar}
                    className="rounded-full w-60 h-60"
                />
                <span className="fa fa-camera absolute bottom-2 right-2 bg-gray-800 px-2 text-white text-lg hover:bg-white hover:text-gray-800"></span>
            </div>
