...
function ApplyBtn({ job, setFulldesc, setShow, nav, index }) {
    return (
        <button
            onClick={() => {
                setFulldesc(index);
            ...
            className={`bg-gray-800 text-white py-3 px-4 rounded ${job.applied? 'italic' : 'hover:shadow-xl cursor-pointer hover:shadow-gray-700 hover:outline hover:outline-white transition duration-300'}`}
