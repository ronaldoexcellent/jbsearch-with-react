...
function ApplyBtn({ job, setFulldesc, setShow, nav, index, classes }) {
    return (
        <button
            ...
            className={`bg-gray-800 text-white ${classes} ${job.applied? 'italic' : 'hover:shadow-xl cursor-pointer hover:shadow-gray-700 hover:outline hover:outline-white transition duration-300'}`}
