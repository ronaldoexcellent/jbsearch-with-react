                    ...
                    {/* <Card style={{ margin: '0px auto'}} className="bg-black"> */}
                        <Skeleton loading={loading} active>
                            ...
                            <div className="bg-gray-300 bottom flex justify-between text-center font-sans font-bold p-3 text-sm text-gray-600">
                                <button
                                  className={`bg-green-600 text-white py-3 px-4 cursor-pointer hover:shadow-xl hover:shadow-gray-700 hover:outline hover:outline-white transition duration-300'}`
                                }>
                                  Approve
                                </button>
                                <button
                                    className={`bg-red-600 text-gray-800 py-3 px-4 cursor-pointer hover:shadow-xl hover:shadow-gray-700 hover:outline hover:outline-white transition duration-300'}`}
                                >
                                    Reject
                                </button>
                            </div>
