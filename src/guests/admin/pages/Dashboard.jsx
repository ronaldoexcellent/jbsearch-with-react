    ...
    <>
      ...
      >
        ...
        <section className="grid sm:grid-cols-3 p-3 gap-2 justify-center text-center w-full cursor-pointer">
          <figure className="hover:bg-white hover:text-gray-800 p-6 bg-gray-800 text-white border-2 border-gray-800 transition duration-300 w-screen grid justify-center sm:w-full h-40 rounded-xl fab fa-face">
        ...
        <div className={`min-h-screen flex flex-col`}>
          <main className="flex-grow p-4">
            <section className="bg-white p-6 rounded shadow">
              <h2 className="text-lg font-bold mb-4">Jobs Overview</h2>
              <ApplicationChart />
            </section>
          </main>
        </div>
