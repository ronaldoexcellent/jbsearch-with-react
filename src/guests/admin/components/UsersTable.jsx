...
function UsersTable() {
    ...
    return (
        <motion.div
            ...
            className=" md:w-[630px] mx-auto md:px-4 mb-4"
        >
                                    ...
                                    <tr key={index} className="hover:bg-gray-200">
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 whitespace-nowrap p-4">
                                            <td className="relative w-full grid gap-2">
                                                ...
                                                >
                                                    <td
                                                        className={`w-[85%] lg:w-[80%] hover:shadow-lg ${!user.status? "bg-emerald-500 hover:bg-emerald-700 transition duration-300 float-right":"bg-red-500 hover:bg-red-700"} shadow-none flex font-semibold flex-col text-center whitespace-nowrap text-white justify-center`}
                                                    >
