...
function ApplicantList({ Jobs, applicants, toggleOptions, accept, reject }) {
  ...
  return (
    <div className="max-w-4xl w-full sm:w-11/12 md:w-[650px] lg:w-[850px] md:mt-2 p-4 pb-8 md:p-6 h-[93%] m-auto overflow-hidden bg-white shadow-md rounded-lg grid grid-rows-4 md:block">
          ...
          >
            ...
            <p>
              <button
                ...
                className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 mt-3 border-2 hover:border-white hover:shadow-xl"
              >
                Actions&nbsp;
                <i
                  className={`fa ${
                    applicant.options ? "rotate-180" : "rotate-0"
                  } fa-caret-up transition duration-300`}
                ></i>
              </button>
            </p>
            ...
            {applicant.options && (
              <div className="top-36 bg-gray-300 rounded-lg shadow-xl w-full md:w-[200px] cursor-pointer flex md:grid md:fixed gap-2 items-center z-[600]">
