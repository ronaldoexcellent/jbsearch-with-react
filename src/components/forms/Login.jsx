...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    else if (email === "e@e.com" && pass === "employer") {
      submitTrue("/employer/")
    }
    
    else if (email === "a@a.com" && pass === "admin") {
      submitTrue("/admin/")
    }
      ...
      >
        ...
        <div className="w-full max-w-md absolute lg:static bg-white px-6 pt-3 pb-8 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <div className="flex items-center border-b border-gray-500 py-2">
                <i className='fa fa-at text-gray-700 mr-2'></i>
                <input
                  type="email"
                  id="email"
            ...
            <button
              type="submit"
              className="w-full bg-gray-800 text-white py-2 rounded hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500"
            >
          ...
          <p className="mt-4 text-center text-gray-700">
            ...
            <button onClick={() => navigate('/signup')} className="text-gray-500 hover:underline">
              Sign Up
            </button>
          </p>
        </div>
